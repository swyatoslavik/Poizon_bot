...
async def command_start(message: types.Message):
    await message.answer(
        ...
        "Для оформления заказа воспользуйтесь кнопками или напишите менеджеру: @poizonpapa_manager. Мы всегда готовы помочь вам с выбором товара и ответить на любые вопросы. 🤗\n"
